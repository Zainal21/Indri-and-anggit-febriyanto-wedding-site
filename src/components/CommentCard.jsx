...
export default function CommentCard({
  ...
  return (
    <>
      <div tw="flex-col my-5 w-full py-4 mx-auto bg-white border-b-2 border-r-2 border-gray-200 sm:px-4 sm:py-4 md:px-4 rounded-lg  md:w-2/3 shadow-xl hover:shadow-2xl border-none bg-gray-100">
        <Badge attending={attending}>
          <strong> {attending == 'true' ? 'Hadir' : 'Tidak Hadir'}</strong>
        </Badge>
        <div tw="flex flex-row">
          <div tw="flex-col mt-1">
            <div tw="flex items-center flex-1 px-4 font-bold leading-tight">
              <p tw="text-base">
                {name} {plusone !== null ? ' & ' + plusone : '-'}{' '}
              </p>
